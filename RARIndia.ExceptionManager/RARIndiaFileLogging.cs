...
{
    public static class RARIndiaFileLogging
    {
        #region Enum Mode
        ...
        public const string LogComponentFilePath = "~/data/logs/{yyyy-mm-dd}/RARIndia_{ComponentName}_Log.log";
        public const string LogFilePath = "~/data/logs/{yyyy-mm-dd}/RARIndia_Log.log";
