...
using RARIndia.DataAccessLayer.Extensions;
using RARIndia.DataAccessLayer.Helper;
using RARIndia.DataAccessLayer.Helpers;
...
{
    public class RARIndiaRepository<T> : IRARIndiaRepository<T> where T : class
    {
        #region Declarations

        readonly private IDBContext _context;

        public virtual bool IsUserWantToDebugSql { get; set; } = RARIndiaSetting.IsUserWantToDebugSql;

        #endregion

        #region Constructor

        public RARIndiaRepository()
        {
        ...
        public RARIndiaRepository(IDBContext context)
        {
            _context = context;
            #if DEBUG
             if (IsUserWantToDebugSql)
        ...
        public RARIndiaRepository(int commandTimeout)
        {
            _context = HelperMethods.CurrentContext;
        ...
        public virtual T Insert(T entity)
        {
            ...
            catch (Exception ex)
            {
                ...
                RARIndiaFileLogging.LogObject(typeof(T), entity, ex);
                throw;
            }
            return entity;
        }
        ...
        public virtual IEnumerable<T> Insert(IEnumerable<T> entities)
        {
            ...
            catch (Exception ex)
            {
                ...
                RARIndiaFileLogging.LogObject(typeof(IEnumerable<T>), entities, ex);
                throw;
            }
        }
        ...
        public virtual bool BatchUpdate(IEnumerable<T> entities)
        {
            ...
            {
                RARIndiaFileLogging.LogObject(typeof(T), entities, ex);
                throw;
            }
        }
        ...
        public virtual bool Delete(string whereClause, object[] values)
        {
            ...
            {
                RARIndiaFileLogging.LogObject(typeof(IEnumerable<T>), whereClause, ex);
                throw;
            }
        }
        ...
        public virtual T GetEntity(string where, List<string> navigationProperties, object[] values)
        {
            ...
            {
                RARIndiaFileLogging.LogObject(typeof(T), item, ex);
                throw;
            }
            return item;
        }
        ...
        public virtual IList<T> GetEntityList(string where, string orderBy, List<string> navigationProperties, object[] values)
        {
            ...
            {
                RARIndiaFileLogging.LogObject(typeof(IList<T>), list, ex);
                throw;
            }
            return list;
        }
        ...
        public virtual IList<T> GetPagedList(string where, string orderBy, List<string> navigationProperties, object[] values, int pageIndex, int pageSize, out int totalCount)
        {
            ...
            {
                totalCount = 0;
                RARIndiaFileLogging.LogObject(typeof(T), list, ex);
                throw;
            }
            return list;
        }
        ...
        private EntitySet GetEntitySet<TEntity>() where TEntity : class
        {
            ...
            {
                RARIndiaFileLogging.LogObject(typeof(TEntity), entitySet, ex);
                throw;
            }
            return entitySet;
        }
